...
import 'package:weather_app/domain/entites/weather.dart' as _i8;
...
class MockWeatherRepository extends _i1.Mock implements _i4.WeatherRepository {
  ...
  _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntity>>
      getCurrentWeatherByName(String? name) => (super.noSuchMethod(
            Invocation.method(
...
/// A class which mocks [WeatherRemoteDateSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockWeatherRemoteDateSource extends _i1.Mock
    implements _i9.WeatherRemoteDateSource {
  MockWeatherRemoteDateSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<_i3.WeatherModel> getCurrentWeatherByName(String? name) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeatherByName,
          [name],
...
class MockGetCurrentWeatherByNameUseCase extends _i1.Mock
    implements _i10.GetCurrentWeatherByNameUseCase {
